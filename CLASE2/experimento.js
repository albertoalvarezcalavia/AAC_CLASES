...
let n1 = parseInt(prompt("Introduce un primer número"));
let n2 = parseInt(prompt("Introduce un segundo número"));
let n3 = parseInt(prompt("Introduce un tercer número"));
let mayor1;
let mayor2;
let suma;
...
//    console.log(`El mayor es: ${mayor1}. El segundo mayor es ${mayor2}`);
    alert(`La suma de los dos números mayores es: ${suma}`);
...
console.log(`Tu edad en 2023 es de ${año} años`);
